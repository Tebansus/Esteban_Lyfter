...
class SalesRepo:
    def __init__(self, pg_manager):
        ...
        self.addresses_table = Table(
            ...
            Column("user_id", Integer, ForeignKey("react_schema.users.id")),
        ...
        self.invoices_table = Table(
            ...
            Column("id", Integer, primary_key=True),
            Column("user_id", Integer, ForeignKey("react_schema.users.id")),
            Column("billing_address_id", Integer, ForeignKey("react_schema.addresses.id")),            
        ...
        self.invoice_items_table = Table(
            ...
            self.pg_manager.metadata,
            Column("id", Integer, primary_key=True),
            Column("invoice_id", Integer, ForeignKey("react_schema.invoices.id")),
            Column("product_id", Integer, ForeignKey("react_schema.products.id")),
